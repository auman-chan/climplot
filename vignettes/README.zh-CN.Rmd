...
NOTE: 同时请引用程序包['climatol'](https://CRAN.R-project.org/package=climatol),
['climaemet'](doi:10.32614/CRAN.package.climaemet)包和数据 [Worldclim](https://worldclim.org/data/monthlywth.html).
