...
[![minimal R version](https://img.shields.io/badge/R-`r stringr::str_extract(grep(pattern="R \\(>= [0-9].[0-9]{1,}.[0-9]{1,}\\)", ignore.case = TRUE, readLines(con = "./DESCRIPTION"), value = TRUE),
pattern=">= [0-9].[0-9]{1,}.[0-9]{1,}")`-6666ff.svg)](https://cran.r-project.org/)
...
[git2r](https://cran.r-project.org/package=git2r). If you want to see more help of this package, please add `build_vignettes= TRUE`.
