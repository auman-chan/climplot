...
搜索和处理多个地点的气候数据是一项具有挑战性的工作。函数 `clim_extract`可以检索来自Worldclim 的历史月度天气数据(2010-2019年2.5度分版本，<https://worldclim.org/data/monthlywth.html>)的数据,为图表可视化做好准备。
...
```{r echo=FALSE}
a <- read.csv("D:/R_data/cimplot_t/vignettes/climdata.csv")
...
clim_plot(loc,xlab="M",mlab = "en",
          ...
          ylab2 ="Precipitation(mm)",ShowForst = TRUE)
```
